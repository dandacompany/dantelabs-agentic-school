...
export default {
  ...
  install: {
    ...
    optionCommon: 'Include common utilities',
    optionDryRun: 'Show what would be installed without making changes',
    optionTarget: 'Target platform (claude, gemini, antigravity, codex, opencode, openclaw, agents)',
  ...
  sample: {
    ...
    downloadHint: 'Download: npx dlabs sample <name>',
    downloadAllHint: 'Download all: npx dlabs sample --all',
